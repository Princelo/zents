...
<div class="item-block playerlist-details">
    <div class="search-block">
        <form action="<?=base_url();?>index.php/playerlist50/index" method="post">
            <label>选手搜索：</label>
                ...
                <li <?=($n%4==0)?"class=\"left\"":"";?>>
                    ...
                    <div class="player-intro">
                        ...
                        <div><a class="play" href="<?=$v->link;?>" ></a>
                            ...
                            <a class="<?=($is_voted)?"yes":"vote semivote";?>" href="<?=($is_voted)?"javascript:void(0);":base_url()."index.php/semifinalsvote/index/".$v->id;?>"></a></div>
                    </div>
                </li>
            <? } ?>
        <? } ?>
