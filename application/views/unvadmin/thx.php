...
<div id="col3" role="main" class="one_column">
    <div id="col3_content" class="clearfix">
        ...
        <div class="info view_form">
            <h2>鸣谢单位  管理 </h2><h1 style="color:#f00"><?=$error;?></h1>
            <table width="70%">
                <!--<col width="50%">
                <col width="50%">-->
                <tr>
                ...
                <? foreach($thxlist as $k => $v){ ?>
                    ...
                    <tr <?=($n%2==0)?"class=\"even\"":"class=\"odd\""?>>
                        ...
                        <td><img src="<?=$v->pic;?>" width="137" /></td>
                        <td><a href="<?=base_url()?>index.php/unvadmin/thxedit/<?=$v->id;?>">EDIT</a></td>
            ...
            <script>
                function myconfirm(id){
                    if (confirm("are you sure?")){
                        window.location.href = "<?=base_url()?>index.php/unvadmin/thxdelete/"+id;
                    } else {
